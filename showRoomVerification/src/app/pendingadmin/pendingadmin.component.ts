...
@Component({
  selector: 'app-pendingadmin',
  templateUrl: './pendingadmin.component.html',
  styleUrls: ['./pendingadmin.component.css'],
})
export class PendingadminComponent implements OnInit {
  ...
  changeDocStatus(userId: any,docId:any) {
    const selectedStatus = this.docStatusForm.value.status;
    console.log(selectedStatus);
    const fileData: IUpdateFileData = { userId,docId, status: selectedStatus };
